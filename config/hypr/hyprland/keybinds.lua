...
hl.bind("SUPER + M", hl.dsp.exec_cmd("wlogout -p layer-shell"), { description = "Session: Shut down" })
...
hl.bind("SUPER + P", hl.dsp.window.pseudo(), { description = "Window: Pseudo" })
...
hl.bind("SUPER + R", hl.dsp.exec_cmd("pkill fuzzel || fuzzel"), { description = "App: Launcher" })
